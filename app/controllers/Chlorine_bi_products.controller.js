...
const Chlorine_bi_products_datas = require('../models/Chlorine_bi_products_datas.model.js');
const common = require('../models/common.model.js');
const Note = require('../models/Chlorine_bi_products.model.js');
...
function finding_all(res,data,size,temp,i,r,length_common){
    ...
    Chlorine_bi_products_datas.find(query)
    .then(notes => {      
        ...
        // //console.log(("vvbnbvv in finding  notes",notes,"i,,,,,,",i)
            ...
            var before_filtering=((1-(parseFloat(Filtering)/100))*notes[j].Zone).toFixed(2)
                Chlorine_bi_products_datas.updateOne({
