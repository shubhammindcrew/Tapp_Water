const metals_datas = require('../models/metals_datas.model.js');
var asyncLoop = require('node-async-loop');
const Note = require('../models/metals.model.js');
...
function finding(res,data,size,temp,i){
    ...
    .then(notes => {
            ...
            metals_datas.updateOne({
                    ...
                    //console.log(("-----------------")
                    //console.log(("In finding in find in update in if condition (update doc)",i,"-----------",j)
                    //console.log(("-----------------","full array i",size-1)
                    //console.log(("-----------------","full array j",size-1)
                    // return false;                
                            if((i==size-1) && (j==notes.length-1) ){
                            
                                //console.log(("-----------------")
                                //console.log(("In finding in find in update in if  condition in if  response true")
                                //console.log(("-----------------")
                                res.send({data:"success"});
                    ...
                    update_data.push(msg) 
                    //console.log(("-----------------")
                    //console.log(("In finding in find in update in else")
                    //console.log(("-----------------")
                    if((i==size-1) && (j==notes.length-1) ){
                        //console.log(("-----------------")
                        //console.log(("In finding in find in update in else  condition if in")
                        //console.log(("-----------------")
                        res.send({data:"success"});
