...
const Note = require('../models/Perfluorinated_chemicals_.model.js');

const Perfluorinated_chemicals_datas= require('../models/Perfluorinated_chemicals_datas.model.js');
...
function finding_all(res,data,size,temp,i,r,length_common){
    ...
    Perfluorinated_chemicals_datas.find(query)
    .then(notes => {      
        ...
        // //console.log(("vvbnbvv in finding  notes",notes,"i,,,,,,",i)
            ...
            var before_filtering=((1-(parseFloat(Filtering)/100))*notes[j].Zone).toFixed(2)
                Perfluorinated_chemicals_datas.updateOne({
